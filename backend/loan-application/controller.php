...
$Authentication->pageAccessor([MyUsers::STAFF_TYPE[0]], $staffInfo[MyUsers::STAFF['name']]['type']);
...
$where = [['column' => 'status', 'comparsion' => '=', 'bindAbleValue' => 'applied']];
            ...
            <tr>
                ...
                <td>
                   <form action='processor.php' method='post'>  
                        <input type='hidden' name='loanId' value='{$aResult['id']}'/>
                        <input type='hidden' name='amount' value='{$aResult['amount']}'/>
                        " . MyTag::getCSRFTokenInputTag() . "
                        <button type='submit' name='action' value='process' class='btn btn-primary btn-sm'>Approve</button><br/>
                    </form>
