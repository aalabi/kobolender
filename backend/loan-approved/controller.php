...
$title = SITENAME . " Approved Loan";
$pageName = "Approved Loan";
$sideBar = $Tag->createSideMenu(['loans', 'approved'], $staffId);
$headerFiles = [
    'css' => [
...
$where = [['column' => 'status', 'comparsion' => '=', 'bindAbleValue' => 'approved']];
