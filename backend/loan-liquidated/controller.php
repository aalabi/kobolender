...
$title = SITENAME . " Liquated Loan";
$pageName = " Liquated Loan";
$sideBar = $Tag->createSideMenu(['loans', 'liquidated'], $staffId);
$headerFiles = [
    'css' => [
...
$where = [['column' => 'status', 'comparsion' => '=', 'bindAbleValue' => 'Liquated']];
