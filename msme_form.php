                ...
                <form action="msme-form-processor.php" id="loanForm" class="row g-4" enctype="multipart/form-data" method="POST">
                    ...
                    <fieldset>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input required type="text" name="company_name" id="" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="company name" class="col-md-4 col-form-label">TIN *</label>
                            <div class="col-md-8">
                                <input required type="text" name="company_tin" id="" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea required name="company_address" id="" cols="30" rows="4" class="form-control" placeholder="Address"></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Nature of Business *</label>
                            <div class="col-md-8">
                                <input required type="text" name="nature_of_business" id="" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Business Phone Number *</label>
                            <div class="col-md-8">
                                <input required type="number" name="company_phone" id="" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                    ...
                    <fieldset>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <input type="number" step="0.01" name="directDebit" id="" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3" id="mamaboy">
                            ...
                            <div class="col-md-7">
                                <input type="number" step="0.01" name="dueObligation" id="" class="form-control">
                            </div>
                        </div>
                    </fieldset>
                    <hr /><br />
                    <fieldset>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input required type="number" step="0.01" name="loan_amount" id="" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">Loan Purpose *</label>
                            <div class="col-md-8">
                                <input required type="text" name="loan_purpose" id="" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="collateral" class="col-md-4 col-form-label">Collateral *</label>
                            <div class="col-md-8">
                                <input required type="text" name="collateral" id="" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label">
                        ...
                        <div id="promoterContainer">
                            <div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input required type="text" name="promoter_name" id="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input required type="text" name="bvn_nin_no" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-md-4 col-form-label">
